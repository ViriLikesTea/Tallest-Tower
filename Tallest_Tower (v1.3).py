...
\==\.-.  - ,-./  \==\-/\ \     .-,.'|      .-,.'|       |==|-  _.-` /==/_ ,_.' \==\.-.  - ,-./        \==\.-.  - ,-./  /==/_,  ,  - \  |, \=/\=|- |==|   |==|-  _.-`  /==/  `   \  
 `--`\==\- \     /==/-|_\ |   |==|, |     |==|, |       |==|   `.-. \==\  \     `--`\==\- \            `--`\==\- \    |==|   .=.     | |- |/ |/ , /==/   |==|   `.-. |==|-, .=., | 
      ...
      /==/ -/   \==\ _.\=\.-' /==/ - , ,/ /==/ - , ,/  /==/ ,     / \==\ - , /       /==/ -/                /==/ -/     '.='. -   .'     |-  /\ /==/    /==/ ,     / /==/  /\ ,  ) 
      `--`--`    `--`         `--`-----'  `--`-----'   `--`-----``   `--`---'        `--`--`                `--`--`       `--`--''       `--`  `--`     `--`-----``  `--`-`--`--'  
        (Tallest Tower, Text-Based Adventure Game, v1.3)

        """)

name = ""

outdoor_guards = False
...
def cellchoice3(): # Cell Choices after disturbing skeleton
     dialogue = input("What will you do? (type a letter) \nA. Talk to the guard \nB. Examine the hay pile\nC. Something... bad?\n")
     if dialogue.lower() == "a":
          talkguard()
          dialogue = input("What will you say/do? (type a letter)\nA. Bribe Guard\nB. Claim innocence\nC. Offer Orb\n")
...
def escape(): # Normal (and boring) escape win
     if outdoor_guards == False:
          ...
          ch = ranch(1, 4)
          waitfunc(2)
          print("You unlock the gate, revealing a mass of guards standing in your way to freedom.")
          waitfunc(1)
          if ch == "4":
               print("You manage to run past them and escape.")
               waitfunc(1)
               print("Congrats on the escape win (4/4).")
               playagain()
          
          elif ch == "3":
               print("You manage to duck under the first few swords but are eventually cut down.")
               waitfunc(2)
               print("You died!")
               waitfunc(1)
               playagain()
               ...
               print("You are almost instantly cut down.")
               waitfunc(1)
               print("You died!")
               waitfunc(1)
               playagain()
...
def badtime():
    global outdoor_guards
    global guarddeaths
    print("Because for some reason you have a death wish, you pluck the blue gem from the skeleton's left eye. \nUpon closer inspection, the gem seems to have yellow inclusions in it.")
    ch = ranch(1, 13)
    if ch == 1:
        print("After picking up the gem, you are teleported out of the prison.")
        waitfunc(2)
        print("You win!")
     ...
     waitfunc(2)
     print("The guard is impaled by a floating sword. This counts as murder.")
     guarddeaths += 1
     waitfunc(2)
     print("The cell is left open, as the guard has died.")
     waitfunc(2)
     escape_jailcell()

    elif ch >= 10 and ch <= 12:
         waitfunc(2)
         print("You immediately die.")
         waitfunc(1)
         playagain()

    elif ch == 13:
        print("The gem begins to glitch. The sky turns red. The guard begins to panic as he sees what you have done.")
        print("Guard: WHAT HAVE YOU DONE?!")
        waitfunc(2)
        print("You don't even have time to tell him you don't know before he is corrupted and he glitches out of existence with a contorted scream.")
        waitfunc(2)
        print("The door disappears and your cell begins to dissolve into zeroes and ones. You run for the stairs.")
        waitfunc(2)
        print("L\n   L\n      L\n   L\nL\n   L\n      L")
        print("You stop at the bottom of the stairs and look behind you. There are contorted and glitched ambient sounds playing as the world dissolves away.")
        waitfunc(2)
        print("You run past the library, which has caught fire. You run past the barracks, trying to force the contorted screams of agony out of your mind.")
        waitfunc(2)
        print("You run to the door and desperately try to open it. It's locked. You're panicking.")
        waitfunc(2)
        look = input("Look behind you?\nYes\nNo\n")
        if "y" in look.lower():
            print("You look behind you to see a white void closing in on you.\n\nYou try to scream for help.\n\n\nBut nobody came.\n\n\n\n")

        else:
            print("You cannot bring yourself to look. You try to whisper a prayer.\n\n\nBut you have no voice with which to pray.\n\n\n\n")
            waitfunc(2)

        print("This is all your fault.\n\n\n\n")
        print("The void consumes your body. All is white. Nothing is there.\n...\n\n\n......\n\n\n.........\n\nIs this what you wanted?\n...\n....\n.....\n......\n.......\n........\n.........\n..........\n...........\nIf only you had just served your sentence.")
        waitfunc(2)
        print("You died!")
        waitfunc(1)
        playagain()
